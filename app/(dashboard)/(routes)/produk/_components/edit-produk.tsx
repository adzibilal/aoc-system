...
const EditProduk = ({ onClose, onSuccess, initialData, cabangId }: EditProdukProps) => {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            deskripsi: initialData.deskripsi ?? undefined,
        },
    })
    ...
    return (
        <>
            ...
            <div className='z-50 bg-white p-5 rounded-md top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] fixed w-[90%] max-w-[500px]'>
                <div className='font-bold text-xl mb-5'>Edit Produk</div>
